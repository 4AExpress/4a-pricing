...
USER_PROMPT = """Κάνε web search για: "DHL fuel surcharge Greece weekly 2026"
και επίσης: "DHL Express fuel surcharge May 2026 percentage"

Βρες τις τρέχουσες εβδομαδιαίες τιμές επίναυλου καυσίμων DHL για:
1. Διεθνείς αποστολές AIR (Express Worldwide)
2. Οδικές αποστολές ROAD (Economy Select)

Επίστρεψε ΜΟΝΟ αυτό το JSON (χωρίς markdown backticks, χωρίς άλλο κείμενο):
{
  "air": [
  ...
  "road": [
    ...
    {"week": "Μάιος 4-10, 2026",  "pct": 35.25}
  ]
}

Σημαντικό:
- Η ΠΡΩΤΗ εγγραφή είναι η επόμενη εβδομάδα
- Η ΔΕΥΤΕΡΗ είναι η τρέχουσα
- Αν δεν βρεις ROAD, βάλε null
